...
//	  echo $kwerenda;
	...
	if(isset($_GET['tytul'])){
		...
		$Staretytul=$tytul;
        $opis=mysqli_real_escape_string($polaczenie,$_GET['opis']);
        $Stareopis=$opis;
        $imie=mysqli_real_escape_string($polaczenie,$_GET['imie']);
        $Stareimie=$imie;
        $lok=mysqli_real_escape_string($polaczenie,$_GET['lok']);
        $Starelok=$lok;
        $tel=mysqli_real_escape_string($polaczenie,$_GET['tel']);
        $Staretel=$tel;
...
<div class="test00">Dodaj ogłoszenie</div>
    ...
    <div id="kategorie1">
       <input type="text" name="tytul" value="<?php echo $krotka['tytul'];?>"  required><br/>
...
<div class="select">
    ...
    <textarea autoResize() value="<?php echo $Stareopis;?>" name="opis" placeholder="Tutaj wpisz opis (Max = 1000 znaków)"   maxlength="1000" required></textarea>
