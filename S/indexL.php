...
<head>
 <meta charset="utf-8"/>
  <title>Domator</title>  
    ...
    <div id="topbarR"><?php echo "Zalogowany jako: ".$_SESSION['user'];?><br/><a i class="icon-home-outline"  href="panelU.php">Konto</a> </div>  
 <div style="clear:both;"></div>
    ...
    <div id="kategorie">
        ...
        <a href="d.php">  <div class="test">Domy</div></a>
        <a href="dz.php">  <div class="test00">Działki</div></a>
        <a href="bik.php"> <div class="test1">    Biura i lokale</div></a>
