                    ...
                    if($polaczenie -> connect_errno!=0){
                        ...
                        if($rezultat = @$polaczenie->query($kwerenda)){
                            ...
                            if($ile_o>0){         
                                ...
                                echo "<th>Tyuł</th><th>Kategoria</th><th>Typ</th><th>Opis</th><th>Imie</th><th>Lokalizacja</th>><th></th>";
                                
                                //for($i=1; $i<=$ile_samochodow;$i++){
                                
                                do{
                                //while($wiersz2 = mysqli_fetch_array($rezultat)){    
                                    echo "<tr><td><img src=\"../obrazki/".$_SESSION['user']."/".$_SESSION['tytul']."/1.jpg\"></td><td>".$wiersz['tytul']."</td><td>".$wiersz['kategoria']."</td><td>".$wiersz['typ']."</td><td>".$wiersz['opis']."</td><td>".$wiersz['imie']."</td><td>".$wiersz['lok']."</td>
