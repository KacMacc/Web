        ...
        <div class="row mt-4">
          ...
          <div class="col-lg-4">
            <button class="btn btn_info float-right" @click="showAdd=true">
              <i class="fas fa-user"></i>&nbsp;&nbsp;Block new card number
            </button>
        ...
        <div class="row">
          <div class="col-lg-12">
            <table class="table table-bordered table-striped">
              ...
              <tbody>
                <tr class="text-center" v-for="card_number in numbers">
                  <td>{{card_number.id}}</td>
                  <td>{{card_number.card_number}}</td>
                  <td>
                    <a href="#" class="text-danger" @click="deleteModel=true; selectNumber(card_number);" 
              ...
              <form action="#" method="post">
                <div class="form-group">
                  <input
                    ...
                    required
                    v-model="newPNumber.card_number"
                  />
                </div>
                <!--<div class="form-group">
                  <input
          ...
          <div class="modal-content">
            ...
            <div class="modal-body p-4">
              <h4 class="text-danger">
                Do you want to delete this bloked card number?
              </h4>
              <h5>Usuwasz '{{currentNumber.card_number}}'</h5>
              <hr />
      ...
      <div id="overlay" v-if="useModel">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body p-4">
              <h4 class="text-danger">
                Do you want to USE this card number?
              </h4>
              <h5>Używasz '{{currentNumber.card_number}}'</h5>
              <hr />
      ...
      var app = new Vue({
        ...
        methods: {
            getAll_Phone_numbers(){
                axios.get("http://localhost/mgr/v/process2.php?action=read_blocked_phones").then(function(response){
            ...
            addPhone(){
              ...
              axios.post("http://localhost/mgr/v/add2.php", formData).then(function(response){
                app.newPNumber={card_number: ""};
            ...
            deletePhone(){
              ...
              axios.post("http://localhost/mgr/v/process2.php?action=delete_blocked", formData).then(function(response){
                app.currentNumber={};
                    if(response.data.error){
                        app.errorMsg = response.data.message;
                    }else{
            ...
            selectNumber(card_number){
              app.currentNumber = card_number;
            },
            clearMsg(){
              app.errorMsg = "";
              app.successMsg = "";
