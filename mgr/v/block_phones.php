        ...
        <div class="row mt-4">
          ...
          <div class="col-lg-4">
            <button class="btn btn_info float-right" @click="showAdd=true">
              <i class="fas fa-user"></i>&nbsp;&nbsp;Block new phone number
            </button>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title">Block new phone number window</h5>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body p-4">
              ...
              <h5>Deleting: '{{currentNumber.phone_number}}'</h5>
              <hr />
      ...
      var app = new Vue({
        ...
        methods: {
            getAll_Phone_numbers(){
                axios.get("http://localhost/mgr/v/process.php?action=read_blocked_phones").then(function(response){
            ...
            deletePhone(){
              ...
              axios.post("http://localhost/mgr/v/process.php?action=delete_blocked_phones", formData).then(function(response){
                app.currentNumber={};
                    if(response.data.error){
                        app.errorMsg = response.data.message;
                    }else{
