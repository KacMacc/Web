            ...
            <table class="table table-bordered table-striped">
              ...
              <tbody>
                <tr class="text-center" v-for="card_number in numbers">
                  ...
                  <td>
                    <a href="#" class="text-select" @click="useModel=true; selectNumber(card_number);"
          ...
          <div class="modal-content">
            ...
            <div class="modal-body p-4">
              <h4 class="text-danger">
                Do you want to delete this card number?
              </h4>
      ...
      var app = new Vue({
        ...
        methods: {
            getAll_Phone_numbers(){
                axios.get("http://localhost/mgr/v/process2.php?action=read").then(function(response){
            ...
            deletePhone(){
              ...
              axios.post("http://localhost/mgr/v/process2.php?action=delete", formData).then(function(response){
                app.currentNumber={};
                    if(response.data.error){
                        app.errorMsg = response.data.message;
                    }else{
            ...
            usePhone(){
              var formData = app.toFormData(app.currentNumber);
              axios.post("http://localhost/mgr/v/process2.php?action=use", formData).then(function(response){
                app.currentNumber={};
                    if(response.data.error){
                        app.errorMsg = response.data.message;
                    }else{
